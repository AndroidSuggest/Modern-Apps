...
/**
 * Screenshot generator driven by `:speech:metadata`.
 * Captures offline model download / setup UI.
 */
...
class MetadataScreenshots {
    ...
    fun generateStoreScreenshots() {
        composeRule.waitUntil(timeoutMillis = 15_000) {
            composeRule.onAllNodesWithText("Speech", substring = true).fetchSemanticsNodes().isNotEmpty() ||
