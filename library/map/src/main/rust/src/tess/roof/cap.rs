...
use tilecodec::mamaps::body::{ROOF_DOME, ROOF_GABLED, ROOF_HIPPED, ROOF_PYRAMIDAL, ROOF_SKILLION};
...
pub(crate) fn emit_roof(
    ...
    let pitched = matches!(
        roof_shape,
        ROOF_GABLED | ROOF_HIPPED | ROOF_PYRAMIDAL | ROOF_SKILLION | ROOF_DOME
    );
    if !pitched || rise <= 0.0 {
