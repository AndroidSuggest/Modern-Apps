...
private const val TAG = "ParentalControlsLimits"
 ...
 * `com.vayunmathur.parentalcontrols` is listed as `hidden-api-whitelisted-app` in
...
const val EXTRA_PACKAGE_NAME = "com.vayunmathur.parentalcontrols.extra.PACKAGE_NAME"
