package com.vayunmathur.parentalcontrols.service
...
private const val TAG = "ParentalControlsAppService"
 ...
 */
class ParentalControlsAppService : SupervisionAppService() {
