...
internal object SabrMp4SegmentIndexParser {
    ...
    fun parse(
        ...
        return parse(
            ...
            checkedRangeOffset(metadata.indexRangeEnd, initData.size)
        )
    }
    ...
    fun parse(initData: ByteArray, format: YoutubeSabrFormat): SabrSegmentIndex {
        return parse(initData, 0, initData.size - 1)
    }
    ...
    private fun parseSidx(initData: ByteArray, sidxOffset: Int, rangeEnd: Int): SabrSegmentIndex {
        ...
        if (version == 0) {
            ...
            throw SabrProtocolException("Unsupported MP4 SIDX version: $version")
        }
