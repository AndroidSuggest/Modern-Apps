...
final class SabrSegmentRequest private constructor(
    ...
    companion object {
        ...
        fun initialization(format: YoutubeSabrFormat): SabrSegmentRequest {
            return SabrSegmentRequest(format, true, -1)
        }

        @JvmStatic
        fun media(format: YoutubeSabrFormat, sequenceNumber: Int): SabrSegmentRequest {
            if (sequenceNumber <= 0) {
                throw IllegalArgumentException("SABR media sequence number must be positive")
            }
