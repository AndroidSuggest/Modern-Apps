...
enum class StreamType {
     ...
     * enum constant outside of the extractor as it will never be returned by an
     ...
     * stream. Note that the [StreamInfo] **can also provide audio-only [AudioStream]s**
     * in addition to video or video-only [VideoStream]s.
     *
     * Note that most of the content of an ended live video (or audio) may be extracted as
     * [VIDEO_STREAM regular video contents] (or [AUDIO_STREAM regular audio contents])
     ...
     * [AUDIO_STREAM regular audio streams] later, because the service may encode them
     * again later.
     */
