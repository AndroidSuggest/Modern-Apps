...
internal object SabrWebmSegmentIndexParser {
    ...
    private fun parse(
        ...
        for (i in cueTimes.indices) {
            ...
            val endMs: Long = when {
                ...
                i > 0 -> startMs + maxOf(1L, startMs - cueTimes[i - 1])
                else -> startMs + 1
            }
            entries.add(SabrSegmentIndex.Entry(i + 1, startMs, maxOf(1L, endMs - startMs)))
        }
