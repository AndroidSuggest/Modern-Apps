...
/**
 * An enum to represent the different delivery methods of [Stream streams] which are returned
 * by the extractor.
 */
enum class DeliveryMethod {
    ...
    /**
     * Used for [Stream]s served using YouTube's SABR (Server Adaptive BitRate) protocol.
     *
     * Unlike the other delivery methods, a SABR stream is not fetched from a single URL or a
     * manifest. The client drives a stateful session, POSTing `VideoPlaybackAbrRequest`
