...
class YoutubeTrendingPodcastsEpisodesLinkHandlerFactory private constructor() :
    ListLinkHandlerFactory() {

    companion object {
        const val KIOSK_ID: String = "trending_podcasts_episodes"

        @JvmField
        val INSTANCE: YoutubeTrendingPodcastsEpisodesLinkHandlerFactory =
            YoutubeTrendingPodcastsEpisodesLinkHandlerFactory()

        private const val PATH = "/podcasts/popularepisodes"
    }
