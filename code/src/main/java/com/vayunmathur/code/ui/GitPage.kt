...
import com.vayunmathur.code.util.clearGitDiff
import com.vayunmathur.code.util.clearGitMessage
import com.vayunmathur.code.util.gitCheckout
import com.vayunmathur.code.util.gitClone
import com.vayunmathur.code.util.gitCommit
import com.vayunmathur.code.util.gitCreateBranch
import com.vayunmathur.code.util.gitInit
import com.vayunmathur.code.util.gitPull
import com.vayunmathur.code.util.gitPush
import com.vayunmathur.code.util.gitStage
import com.vayunmathur.code.util.gitUnstage
import com.vayunmathur.code.util.loadGitDiff
import com.vayunmathur.code.util.loadSideBySideDiff
import com.vayunmathur.code.util.refreshGit
import com.vayunmathur.code.util.setGitAuthorEmail
import com.vayunmathur.code.util.setGitAuthorName
import com.vayunmathur.code.util.setGitToken
import com.vayunmathur.code.util.setGitUsername
...
fun GitPage(viewModel: EditorViewModel, backStack: NavBackStack<Route>) {
    ...
    viewModel.gitDiff?.let { diff ->
        GitPageSection(diff = diff, onDismiss = { viewModel.clearGitDiff() })
    }
