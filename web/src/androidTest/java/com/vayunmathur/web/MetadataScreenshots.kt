...
/**
 * Screenshot generator driven by `:web:metadata`.
 * No seeding — captures browser UI states (new tab, bookmarks prompt).
 */
...
class MetadataScreenshots {
    ...
    fun generateStoreScreenshots() {
        composeRule.waitUntil(timeoutMillis = 15_000) {
            composeRule.onAllNodesWithText("Web", substring = true).fetchSemanticsNodes().isNotEmpty() ||
