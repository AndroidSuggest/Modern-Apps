...
#[no_mangle]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_generateKeyPair<'local>(
...
#[no_mangle]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_publicFromPrivate<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_x25519Agreement<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    private: JByteArray<'local>,
...
#[no_mangle]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_sign<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    private: JByteArray<'local>,
...
#[no_mangle]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_verify<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    public: JByteArray<'local>,
    message: JByteArray<'local>,
...
#[no_mangle]
#[allow(clippy::too_many_arguments)]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_processPreKeyBundle<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_encrypt<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_decryptMessage<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    session: JByteArray<'local>,
...
#[no_mangle]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_decryptPreKeyMessage<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    local_private: JByteArray<'local>,
    local_public: JByteArray<'local>,
...
#[no_mangle]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_createSenderKey<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
) -> jobjectArray {
...
#[no_mangle]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_processSenderKey<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_encryptGroup<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
...
#[no_mangle]
pub extern "system" fn Java_com_vayunmathur_messages_whatsapp_e2e_RustWhatsAppCrypto_decryptGroup<'local>(
    mut env: JNIEnv<'local>,
    _class: JClass<'local>,
    state: JByteArray<'local>,
    ciphertext: JByteArray<'local>,
